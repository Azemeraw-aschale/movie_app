...
// import Image from '../../../public/Assets/Images/Tewos.PNG';
  ...
  return (
    <Box sx={{display:'flex',alignItems:'center',height:'100vh',width:'100vw'}}>
        <Box sx={{ background:'black',height:'100vh',width:'50vw'}}>
          <Box sx={{  backgroundImage: "url(https://source.unsplash.com/random)", backgroundRepeat: 'no-repeat',width:'50vw',height:'100vh' }}></Box>
